...
from api.models import Person, Film, CreditsFilm, User, CollectionItem
import random
        ...
        for user in users:
            ...
            for _ in range(num_items):
                item = CollectionItem(
                    ...
                    borrowed_at=fake.date_time_between(start_date="-1y", end_date="now") if fake.boolean(chance_of_getting_true=20) else None,
